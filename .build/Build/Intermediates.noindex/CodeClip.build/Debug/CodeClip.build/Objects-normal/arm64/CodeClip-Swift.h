...
#ifndef CODECLIP_SWIFT_H
#define CODECLIP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CodeClip",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8CodeClip14ClipboardPanel")
...
@class NSControl;
@class NSTextView;
@interface ClipboardPanel (SWIFT_EXTENSION(CodeClip)) <NSSearchFieldDelegate>
...
@interface ClipboardPanel (SWIFT_EXTENSION(CodeClip)) <NSTableViewDataSource, NSTableViewDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC8CodeClip16ClipboardRowCell")
@interface ClipboardRowCell : NSTableCellView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
